...
class CreateDocxFromTemplate extends CreateDocx
{
    ...
    public function cloneBlock($blockName, $occurrence = 1)
    {
        ...
        $contentNodesReferencedWordContent = $domXpath->query('//w:p[w:r/w:t[text()[contains(.,"'.self::$_templateSymbolStart.self::$_templateBlockSymbol.$blockName.self::$_templateSymbolEnd.'")]]][' . $occurrence . ']/following-sibling::*');
        ...
        $contentNodeReferencedToWordContentParent = $domXpath->query('//w:p[w:r/w:t[text()[contains(.,"'.self::$_templateSymbolStart.self::$_templateBlockSymbol.$blockName.self::$_templateSymbolEnd.'")]]][' . ($occurrence + 1) . ']/..');
    ...
    public function deleteTemplateBlock($blockName)
    {
        ...
        foreach ($aType as $type) {
            ...
            $loadContent = preg_replace('/\\' . self::$_templateSymbolStart . $type . $blockName . '\\' . self::$_templateSymbolEnd . '[.|\s|\S]*?\\' . self::$_templateSymbolStart . $type . $blockName . '\\' . self::$_templateSymbolEnd . '/ms', self::$_templateSymbolStart . $variableName . self::$_templateSymbolEnd, $loadContent);
                ...
                if ($options['stylesReplacementType'] == 'usePlaceholderStyles' || $options['stylesReplacementType'] == 'mixPlaceholderStyles') {
                    ...
                    if ($pPrStyles->length > 0) {
                        ...
                        if ($pPrStylesNode->length > 0) {
                            ...
                            $domHTMLFragment->loadXML('<w:root xmlns:wpc="http://schemas.microsoft.com/office/word/2010/wordprocessingCanvas" 
                                    ...
                                    if ($options['stylesReplacementType'] == 'mixPlaceholderStyles') {
                                        ...
                                        foreach ($pPrStyleHTMLFragment->childNodes as $pPrStyleHTMLFragmentNode) {
                                            if (!strstr($pPrStylesXML, $pPrStyleHTMLFragmentNode->tagName)) {
                                                ...
                                                if (!isset($options['stylesReplacementTypeIgnore']) ||(isset($options['stylesReplacementTypeIgnore']) && !in_array($pPrStyleHTMLFragmentNode->tagName, $options['stylesReplacementTypeIgnore']))) {
                                    ...
                                    if ($options['stylesReplacementType'] == 'mixPlaceholderStyles') {
                                        ...
                                        foreach ($rPrStyleHTMLFragment->childNodes as $rPrStyleHTMLFragmentNode) {
                                            ...
                                            if (!strstr($rPrStylesXML, $rPrStyleHTMLFragmentNode->tagName)) {
                                                // don't add the style if it's ignored
                                                if (!isset($options['stylesReplacementTypeIgnore']) ||(isset($options['stylesReplacementTypeIgnore']) && !in_array($rPrStyleHTMLFragmentNode->tagName, $options['stylesReplacementTypeIgnore']))) {
            ...
            if (strpos($cleanNodeText, $searchVariable) !== false) {
                if ($type == 'block') {
                    ...
                    if (self::$_templateSymbolStart == self::$_templateSymbolEnd) {
                        ...
                        $newNodeText = str_replace(self::$_templateSymbolStart . $var . self::$_templateSymbolEnd, self::$_templateSymbolStart . '</w:t></w:r><cursorWordML/><w:r><w:t xml:space="preserve">' . self::$_templateSymbolEnd, $textNode);
                        $newNodeText = str_replace(self::$_templateSymbolStart . '</w:t></w:r><cursorWordML/><w:r><w:t xml:space="preserve">', '</w:t></w:r><cursorWordML/><w:r><w:t xml:space="preserve">', $newNodeText);
