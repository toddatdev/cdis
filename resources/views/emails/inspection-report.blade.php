...
<head>
    ...
    <title>Inspection Report | CDIS</title>
    <!--[if (mso 16)]>
    <style type="text/css">
        a {
        ...
        <tr style="border-collapse:collapse;">
            <td valign="top" style="padding:0;Margin:0;">
                ...
                <table class="es-header" cellspacing="0" cellpadding="0" align="center"
                    ...
                    <tr style="border-collapse:collapse;">
                        <td style="padding:0;Margin:0;background-color:#1ab394;" bgcolor="#1ab394" align="center">
                            <table class="es-header-body"
                                   style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;background-color:#CD5A56;"
                                   width="600" cellspacing="0" cellpadding="0" align="center" bgcolor="#cd5a56">
                                <tr style="border-collapse:collapse;">
                                            ...
                                            <tr style="border-collapse:collapse;">
                                                <td width="600" valign="top" align="center" style="padding:0;Margin:0;">
                                                    <table style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:separate;border-spacing:0px;background-color:#FFFFFF;border-radius:4px;"
                                                        ...
                                                        <tr style="border-collapse:collapse;">
                                                            <td align="center"
                                                                style="Margin:0;padding-bottom:10px;padding-top:20px;padding-left:30px;padding-right:30px;">
                                                ...
                                                <td width="600" valign="top" align="center" style="padding:0;Margin:0;">
                                                    <table style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:separate;border-spacing:0px;border-radius:4px;background-color:#FFFFFF;"
                                                        ...
                                                        <tr style="border-collapse:collapse;">
                                                            <td class="es-m-txt-l" bgcolor="#ffffff" align="left"
                                                                ...
                                                                <p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:18px;font-family:lato, 'helvetica neue', helvetica, arial, sans-serif;line-height:27px;color:#666666;">
                                                                    A new report has been filed by {{ucfirst(session('county'))}} County Conservation District.
                                                                    To download and view your report, click the button below.</p></td>
                                                        </tr>
                                                        <tr style="border-collapse:collapse;">
                                                            <td align="center"
                                                                style="Margin:0;padding-left:10px;padding-right:10px;padding-top:35px;padding-bottom:35px;">
                                                                <span class="es-button-border"
                                                                      style="border-style:solid;border-color:#FFA73B;background:#BD2440;border-width:1px;display:inline-block;border-radius:8px;width:auto;"> <a
                                                                            href="{{ route('inspection.report.download', [$project_id, $auth_code]) }}"
                                                                            class="es-button" target="_blank"
                                                                            style="mso-style-priority:100 !important;text-decoration:none;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:helvetica, 'helvetica neue', arial, verdana, sans-serif;font-size:20px;color:#FFFFFF;border-style:solid;border-color:#1ab394;border-width:15px 30px;display:inline-block;background:#1ab394;border-radius:8px;font-weight:normal;font-style:normal;line-height:24px;width:auto;text-align:center;">Download Report</a> </span>
                                                            </td>
                                                        </tr>
                                                        <tr style="border-collapse:collapse;">
                                                        ...
                                                        <tr style="border-collapse:collapse;">
                                                            <td class="es-m-txt-l" align="left"
                                                                style="padding:0;Margin:0;padding-top:20px;padding-left:30px;padding-right:30px;">
                                                                <a target="_blank" href="{{ route('inspection.report.download', [$project_id, $auth_code]) }}"
                                                                   style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:lato, 'helvetica neue', helvetica, arial, sans-serif;font-size:18px;text-decoration:underline;color:#BD2440;">{{ route('inspection.report.download', [$project_id, $auth_code]) }}</a>
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr style="border-collapse:collapse;">
                                                            <td class="es-m-txt-l" align="left"
                                                                ...
                                                                <p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:18px;font-family:lato, 'helvetica neue', helvetica, arial, sans-serif;line-height:27px;color:#666666;">
                                                                    Sincerely, </p>
                                                                <p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:18px;font-family:lato, 'helvetica neue', helvetica, arial, sans-serif;line-height:27px;color:#666666;">
                                                                    {{ ucfirst(session('county')) }} County Conservation District</p></td>
                                                        </tr>
                                                    </table>
                                                </td>
                                            </tr>
                                ...
                                <tr style="border-collapse:collapse;">
                                    <td align="left" style="padding:0;Margin:0;">
                                        <table width="100%" cellspacing="0" cellpadding="0"
                                            ...
                                            <tr style="border-collapse:collapse;">
                                                <td width="600" valign="top" align="center" style="padding:0;Margin:0;">
                                                    <table style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:separate;border-spacing:0px;background-color:#FFECD1;border-radius:4px;"
                                                           width="100%" cellspacing="0" cellpadding="0"
                                                           bgcolor="#ffecd1">
                                                        <tr style="border-collapse:collapse;">
                                                            <td align="center"
                                                                ...
                                                                <h3 style="Margin:0;line-height:24px;mso-line-height-rule:exactly;font-family:lato, 'helvetica neue', helvetica, arial, sans-serif;font-size:20px;font-style:normal;font-weight:normal;color:#111111;">
                                                                    Copyright CDIS © 2014-{{date('Y')}}</h3></td>
                                                        </tr>
                                                        <tr style="border-collapse:collapse;">
